...
import (
	...
	windsurfagent "github.com/julianramirezreyes/julian-ai/internal/agents/windsurf"
...
func TestInjectClaudeCustomModelAssignments(t *testing.T) {
	...
	if !strings.Contains(text, "<!-- julian-ai:sdd-model-assignments -->") {
...
func TestInjectCursorWritesSDDOrchestratorAndSkills(t *testing.T) {
	...
	promptPath := filepath.Join(home, ".cursor", "rules", "julian-ai.mdc")
...
<!-- END:agent-teams-lite -->`
	...
	sddSection := "<!-- julian-ai:sdd-orchestrator -->\nYou are a COORDINATOR.\n<!-- /julian-ai:sdd-orchestrator -->\n"
...
func TestStripBareOrchestratorSection_DoesNotStripIfMarkersPresent(t *testing.T) {
	...
	// the `!strings.Contains(existing, "<!-- julian-ai:sdd-orchestrator -->")` guard
...
// the <!-- julian-ai:strict-tdd-mode --> marker with its content.
func TestInjectStrictTDDEnabledInjectsMarkerIntoClaude(t *testing.T) {
	...
	text := string(content)
	if !strings.Contains(text, "<!-- julian-ai:strict-tdd-mode -->") {
		t.Fatal("CLAUDE.md missing <!-- julian-ai:strict-tdd-mode --> open marker")
	}
	if !strings.Contains(text, "<!-- /julian-ai:strict-tdd-mode -->") {
		t.Fatal("CLAUDE.md missing <!-- /julian-ai:strict-tdd-mode --> close marker")
	}
...
func TestInjectClaudeDoesNotStripMarkedSection(t *testing.T) {
	...
	if !strings.Contains(string(after1), "<!-- julian-ai:sdd-orchestrator -->") {
...
func TestInjectWindsurf_WorkflowsFoundFromSubdirectory(t *testing.T) {
	...
	// Simulate running julian-ai from a subdirectory inside that project.
